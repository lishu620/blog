export const projects: Project[] = [
  {
    ...
    source: 'https://github.com/mlishu/blog',
  ...
  },
  {
    ...
    source: 'https://github.com/mlishu/js-deobfuscator',
  ...
  },
  {
    ...
    source: 'https://github.com/mlishu/youni',
    tags: ['large', 'product'],
    type: 'web',
  },
  {
    ...
    website: 'https://admin.mlishu.cn',
    source: 'https://github.com/mlishu/nest-vben-admin',
  ...
  },
  {
    ...
    website: 'https://api.mlishu.cn',
    source: 'https://github.com/mlishu/api-service',
  ...
  // toy
  {
    ...
    website: 'https://cx.mlishu.cn',
    source: 'https://github.com/mlishu/chaoxing-sign',
    tags: ['opensource', 'favorite'],
    type: 'toy',
  },
  {
  ...
  },
  {
    ...
    source: 'https://github.com/mlishu/hoppx',
    tags: ['opensource'],
    type: 'toy',
  },
  {
    ...
    source: 'https://github.com/mlishu/link-maker',
    tags: ['opensource'],
    type: 'toy',
  },
  {
  ...
  //   website: 'https://image.mlishu.cn',
  //   source: 'https://github.com/mlishu/image-hosting',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // {
  ...
  //   source: 'https://github.com/mlishu/vitesse-nuxt3-strapi',
  //   tags: ['opensource'],
  //   type: 'web',
  // },
  // personal
  {
    ...
    website: 'https://marketplace.visualstudio.com/items?itemName=mlishu.vscode-extension-sample',
    source: 'https://github.com/mlishu/vscode-extension',
    tags: ['opensource'],
    type: 'personal',
  },
  {
    ...
    website: 'https://example.mlishu.cn',
    source: 'https://github.com/mlishu/example',
  ...
  // },
  // {
  //   title: '@mlishu/eslint-config',
  //   description: '来自 antfu 的 ESLint 配置文件',
  //   website: 'https://github.com/mlishu/eslint-config',
  //   tags: ['opensource', 'personal'],
  //   type: 'personal',
  // },
  // commerce
  ...
  },
  {
    ...
    website: 'https://github.com/mlishu/rpc-browser',
    tags: ['opensource'],
    type: 'other',
  },
  {
    ...
    website: 'https://github.com/mlishu/ocr',
    tags: ['opensource'],
    type: 'other',
  },
  {
    ...
    website: 'https://github.com/mlishu/rust-wasm-md5',
    tags: ['opensource'],
    type: 'other',
  },
]
