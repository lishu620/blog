...
![uniapp](https://img.mlishu.cn/uniapp.png)
...
![image-20220327000608783](https://img.mlishu.cn/image-20220327000608783.png)
...
![image-20220326224649953](https://img.mlishu.cn/image-20220326224649953.png)

查看了下我本地的 HBuilderX 版本是正式版 v3.3.13，而该 Vue3 的模板的 Alpha 版 v3.4.3

![image-20220326225748608](https://img.mlishu.cn/image-20220326225748608.png)
...
![image-20220327002827115](https://img.mlishu.cn/image-20220327002827115.png)
...
![image-20220327005629618](https://img.mlishu.cn/image-20220327005629618.png)
...
然后就是把一些`#ifndef VUE3`不是 vue3 的代码块，以及部分 js 文件改写成 ts 文件即可。这里把我修改后的模板上传到 github 上，有需要的可自行下载：[mlishu/vite-vue3-uniapp (github.com)](https://github.com/mlishu/vite-vue3-uniapp)
