...
演示代码地址：[mlishu/spring-boot-demo (github.com)](https://github.com/mlishu/spring-boot-demo)

## 目录结构展示图

![](https://img.mlishu.cn/20220108011921.png)
...
![image-20220506115207717](https://img.mlishu.cn/image-20220506115207717.png)
...
一般情况下该接口无需定义额外方法，如有需要还可以定义属于自己的查询语句，比如上面的 findByUsername，这时候就注入后的 userRepository 对象就可以使用`userRepository.findByUsername("mlishu");` ，将会返回数据库中该用户名的数据。
...
```java title="service/UserService.java"
import com.mlishu.demo.domain.User;
import com.mlishu.demo.repository.UserRepository;
import com.mlishu.demo.service.UserService;
