...
![image-20221204161431863](https://img.mlishu.cn/image-20221204161431863.png)
...
以下是我的网站测速结果，也可通过访问 [mlishu.cn 在全国各地区网络速度测试情况-Ping.cn](https://www.ping.cn/http/mlishu.cn) 在线查看

![image-20221204161146327](https://img.mlishu.cn/image-20221204161146327.png)
    ...
    steps:
      ...
      - name: SSH Deploy
        ...
        env:
          ...
          REMOTE_USER: 'root'
          TARGET: '/opt/1panel/apps/openresty/openresty/www/sites/mlishu.cn/index'
```
