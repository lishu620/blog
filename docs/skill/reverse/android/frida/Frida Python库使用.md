...
http 发送 get 请求 如 [http://127.0.0.1:8080/getEnc?username=mlishu&password=a123456](http://127.0.0.1:8080/getEnc?username=mlishu&password=a123456)，即可得到 enc 调用后的结果，post 请求同理
