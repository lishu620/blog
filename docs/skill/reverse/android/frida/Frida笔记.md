...
```bash
adb push C:\Users\mlishu\Desktop\frida-server-15.1.14-android-arm64 /data/local/tmp/fsarm64
...
let Utils = Java.use('com.mlishu.app.Utils')
```
...
```javascript
const Utils = Java.use('com.mlishu.app.Utils')
...
var Person = Java.use('com.mlishu.app.Person')
var person = Person.$new('mlishu', 20)
arrayList.add('mlishu')
...
```
adb push C:\Users\mlishu\Desktop\frida-inject-15.1.14-android-arm64 /data/local/tmp/fiarm64
